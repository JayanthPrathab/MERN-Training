...
const HardwareProj = () => {
  const items = [
    ...
    {
      image: "https://images.unsplash.com/photo-1523848309072-c199db53f137?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      link: "https://google.com/",
      title: "CMSS",
      description: "Coal Mining Safety System, an integrated IoT system to prevent and ensure safety of miners in coal mines",
    },
    {
